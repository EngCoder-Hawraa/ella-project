        ...
        icon: `<svg
            ...
            >
              ...
              <g>
                ...
                <path
                  style="fill: #0052b4"
                  d="M8.819,322.784c8.83,32.758,23.993,62.913,44.101,89.075l89.074-89.075H8.819z"
                ></path>
                <path
                  style="fill: #0052b4"
              ...
              <g>
                <path
                  style="fill: #d80027"
                  d="M509.833,222.609h-220.44V2.167C278.461,0.744,267.317,0,256,0c-11.319,0-22.461,0.744-33.391,2.167v220.44H2.167C0.744,233.539,0,244.683,0,256c0,11.319,0.744,22.461,2.167,33.391h220.44v220.442C233.539,511.256,244.681,512,256,512c11.317,0,22.461-0.743,33.391-2.167v-220.44h220.442C511.256,278.461,512,267.319,512,256C512,244.683,511.256,233.539,509.833,222.609z"
                ></path>
                <path
                  style="fill: #d80027"
                  d="M322.783,322.784L437.019,437.02c5.254-5.252,10.266-10.743,15.048-16.435l-97.802-97.802h-31.482V322.784z"
                ></path>
                <path
                  style="fill: #d80027"
                  d="M189.217,322.784L74.98,437.019c5.252,5.254,10.743,10.266,16.435,15.048l97.802-97.804V322.784z"
                ></path>
                <path
                  style="fill: #d80027"
                  d="M189.217,189.219L74.981,74.98c-5.254,5.252-10.266,10.743-15.048,16.435l97.803,97.803H189.217z"
                ></path>
                <path
                  style="fill: #d80027"
                  d="M322.783,189.219L437.02,74.981c-5.252-5.254-10.743-10.266-16.435-15.047l-97.802,97.803V189.219z"
                ></path>
              </g>
            </svg>`,
        lang: "En",
